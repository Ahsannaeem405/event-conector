            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 py-4">
                        <div class="d-flex justify-content-between align-items-center border rounded-2 p-2">
                            <div>
                                <p class="text-grey-three font-13 mb-0">Showing 1-{{$packages->count()}}
                                    of {{$packages->count()}} Results for "Restaurants" </p>
                            </div>
                            <div class="d-flex">
                                ...
                                <select name="sort_by" class="form-select form-select-sm"
                                    ...
                                    <option value="2" {{$request->sort_by==2 ? 'selected' : ''}}>Price Low to High
                                    </option>
                                    <option value="3" {{$request->sort_by==3 ? 'selected' : ''}}>Price High to Low
                                    </option>
                                    <option value="4" {{$request->sort_by==4 ? 'selected' : ''}}>Rating Low to High
                                    </option>
                                    <option value="5" {{$request->sort_by==5 ? 'selected' : ''}}>Rating High to Low
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 col-12 px-2 pt-4">
                        ...
                        <div class="border rounded-2 p-2">
                                ...
                                <div class="input-group mb-3 py-3">
                                    <select name="category" class="form-select" id="inputGroupSelect03"
                                        ...
                                        @foreach($category as $cat)
                                            <option
                                                {{$request->category==$cat->id ? 'selected' : ''}} value="{{$cat->id}}">{{$cat->name}}</option>
                                        @endforeach
                            ...
                            <div class="popularTags">
                                ...
                                @foreach($tags as $tag)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="tagsarray[]"
                                               {{in_array($tag->tag,$request->tagsarray ? $request->tagsarray : []) ? 'checked' : ''}} value="{{$tag->tag}}"
                                               id="flexCheckChecked">
                            ...
                            <div class="eventDate">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="search_date" value="{{$request->search_date}}"
                                           class="form-control border-right-0" id="datepicker2"
                                           aria-describedby="basic-addon2">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <input type="time" name="search_time" value="{{$request->search_time}}"
                                       class="form-control mt-2 ms-1">
                            </div>
                            ...
                            <div class="d-flex justify-content-between border rounded-2 px-2">
                                ...
                                <div class="quantity">
                                    ...
                                    <input name="person" type="text" class="quantity__input"
                                           value="{{$request->person ? $request->person : 1 }}">
                            ...
                            <p>
                                ...
                                <input type="text" name="price" class="text-blue form-control bg-transparent"
                                       id="amount" readonly
                                    ...
                                    <div class="card p-3 shadowDiv border-rounded-1  pb-3">
                                        ...
                                        <div class="card-body pb-0">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <i class="pointer fa fa-heart {{ $package->favourite ? "text-danger" : "text-grey-three" }} pt-2 addfav"
                                                   id="{{$package->id}}" businessid="package"></i>
                                            </div>
                                            <div class="div">
                ...
                <div class="owl-carousel">
                    ...
                    @foreach($resturents as $resturent)
                        <div class="item">
                            <div class="image_div py-3 px-3 position-relative"
                                 style="background-image:url('{{ asset('upload/'.$resturent->logo) }}');">
                                ...
                                <div class="d-flex justify-content-between align-items-end mt-30">
                                    ...
                                    <div class="ms-4">
                                        ...
                                        <a href="{{url('user/restaurant/packages/'.encrypt($resturent->id))}}"><button class="btn btn-green px-3 py-1 h-50 border-rounded-50">Explore</button></a>
                                    </div>
                            ...
                            <div class="text-center py-3">
                                <a href="{{url('user/restaurant/packages/'.encrypt($resturent->id))}}">  <h5 class="text-blue font-16 fontw400">{{$resturent->business}}</h5></a>
