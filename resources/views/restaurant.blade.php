        ...
        <div class="row">
            ...
            <div class="col-6 text-right d-flex justify-content-end py-4">
                <button type="button" class="btn btn-green rounded-pill change_model" form-id="addResturentForm"  data-bs-toggle="modal"
                    ...
                    data-bs-target="#staticBackdrop2">test btn</button>
            </div>
        </div>
                                                ...
                                                <div class="main active" style="overflow-y: scroll; height: 498px;">
                                                    ...
                                                    <div class="input-text">
                                                        <div class="input-div">
                                                            ...
                                                            <input type="file" name="file" required require class="dropify2">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="hoursdiv d-none">
                                                            ...
                                                            <div class="disabl_prnt">
                                                                <div class="d-flex checkbtn">
                                                                    ...
                                                                    <input type="checkbox" id="_24_1stday" name="_24_day1" atty="1"
                                                                        class="setbtn">
                                                            ...
                                                            <div class="disabl_prnt">
                                                                <div class="d-flex checkbtn">
                                                                    <input type="checkbox" id="_24_2ndday" name="_24_day2" atty="1"
                                                                        class="setbtn">
                                                            ...
                                                            <div class="disabl_prnt">
                                                                <div class="d-flex checkbtn">
                                                                    <input type="checkbox" id="_24_3rdday" name="_24_day3" atty="1"
                                                                        class="setbtn">
                                                            ...
                                                            <div class="disabl_prnt">
                                                                <div class="d-flex checkbtn">
                                                                    <input type="checkbox" id="_24_4thday" name="_24_day4"  atty="1"
                                                                        class="setbtn">
                                                            ...
                                                            <div class="disabl_prnt">
                                                                <div class="d-flex checkbtn">
                                                                    <input type="checkbox" id="_24_5thday" name="_24_day5" atty="1"
                                                                        class="setbtn">
                                                            ...
                                                            <div class="disabl_prnt">
                                                                <div class="d-flex checkbtn">
                                                                    <input type="checkbox" id="_24_6thday" name="_24_day6" atty="1"
                                                                        class="setbtn">
                                                            ...
                                                            <div class="disabl_prnt">
                                                                <div class="d-flex checkbtn">
                                                                    <input type="checkbox" id="_24_7thday" name="_24_day7" atty="1"
                                                                        class="setbtn">
...
<section class="package my-5 pt-5">
    <div class="container">
        <div class="row">
            <div class="col-6 py-4">
                <h3 class="mb-3 fontw700">Packages tttttt</h3>
            </div>
            <div class="col-6 text-right d-flex justify-content-end py-4">
                                        ...
                                        <form id="msform" class="addPackageForm" method="post" action="{{ url('/user/add_package') }}"
                                            ...
                                            <fieldset class="">
                                                <div class="form-card">
                                                    ...
                                                    <input type="text" name="package" placeholder="Package Name" required require/>
                                                    <div class="mb-4">
                                                        <label for="allow"
                                                    ...
                                                    <div class="price-radio">
                                                        ...
                                                        <br>
                                                        <input type="number" name="amount" placeholder="Enter package amount" required require/>
                                                    </div>
                                                </div>
                                            ...
                                            <fieldset class="custom_pre_model">
                                                <div class="form-card">
                                                    ...
                                                    <div class="dropi_parent col-12">
                                                        <input name="image[]" type="file" class="dropify2n col-6" required require
                                                ...
                                                <div class="availability"  style="overflow-y: scroll; height: 460px;">
                                                    <div class="">
                                                        ...
                                                        <div class="hoursmaindiv">
                                                            ...
                                                            <div class="hoursdiv d-none col-9 col-md-9" style="margin: auto;">

                                                                <h4 class="mb-0 mt-4 days">Monday</h4>
                                                                <div class="disabl_prnt">
                                                                    <div class="d-flex checkbtn">
                                                                        <input type="checkbox" id="_24_day1" name="_24_day1" atty="1"
                                                                            class="setbtn">
                                                                        <label for="_24_day1"> Available 24 Hours </label>


                                                                        <input type="checkbox" id="holiday31" name="holiday1"
                                                                            class="setbtn">
                                                                ...
                                                                <div class="disabl_prnt">
                                                                    <div class="d-flex checkbtn">
                                                                        <input type="checkbox" id="_24_day2" name="_24_day2" atty="1"
                                                                            class="setbtn">
                                                                        <label for="_24_day2"> Available 24 Hours </label>
                                                                        <input type="checkbox" id="holiday32" name="holiday2"
                                                                            class="setbtn">
                                                                ...
                                                                <div class="disabl_prnt">
                                                                    <div class="d-flex checkbtn">
                                                                        <input type="checkbox" id="_24_day3" name="_24_day3" atty="1"
                                                                            class="setbtn">
                                                                        <label for="_24_day3"> Available 24 Hours </label>
                                                                        <input type="checkbox" id="holiday33" name="holiday3"
                                                                            class="setbtn">
                                                                ...
                                                                <div class="disabl_prnt">
                                                                    <div class="d-flex checkbtn">
                                                                        <input type="checkbox" id="_24_day4" name="_24_day4" atty="1"
                                                                            class="setbtn">
                                                                        <label for="_24_day4"> Available 24 Hours </label>

                                                                        <input type="checkbox" id="holiday34" name="holiday4"
                                                                            class="setbtn">
                                                                ...
                                                                <div class="disabl_prnt">
                                                                    <div class="d-flex checkbtn">
                                                                        <input type="checkbox" id="_24_day5" name="_24_day5" atty="1"
                                                                            class="setbtn">
                                                                        <label for="_24_day5"> Available 24 Hours </label>

                                                                        <input type="checkbox" id="holiday35" name="holiday5"
                                                                            class="setbtn">
                                                                ...
                                                                <div class="disabl_prnt">
                                                                    <div class="d-flex checkbtn">
                                                                        <input type="checkbox" id="_24_day6" name="_24_day6" atty="1"
                                                                            class="setbtn">
                                                                        <label for="_24_day6"> Available 24 Hours </label>

                                                                        <input type="checkbox" id="holiday36" name="holiday6"
                                                                            class="setbtn">
                                                                ...
                                                                <div class="disabl_prnt">
                                                                    <div class="d-flex checkbtn">
                                                                        <input type="checkbox" id="_24_day7" name="_24_day7" atty="1"
                                                                            class="setbtn">
                                                                        <label for="_24_day7"> Available 24 Hours </label>

                                                                        <input type="checkbox" id="holiday37" name="holiday7"
                                                                            class="setbtn">
