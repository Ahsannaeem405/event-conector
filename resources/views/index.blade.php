                ...
                <div class="col-md-12 z1">
                    <div class="bannerText">
                        <p class="text-white fontw500 pt-5 m-0"><span><i class="fa fa-minus fa-lg"
                                                                         aria-hidden="true"></i></span> The Himaliyan
                            Mountain Ranges</p>
                    </div>
                </div>
                        ...
                        <div class="row py-4">
                            <div class="col-lg-3 location">
                                ...
                                <div class="input-group mb-3 mt-2">
                                    <input type="text" id="search_input" name="location" placeholder="Enter Location"
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-lg-4 activities">
                                                ...
                                                <div class="input-group mb-3 mt-2">
                                                    <select class="form-select" name="category" id="inputGroupSelect03"
                                            ...
                                            <div class="col-lg-4 Datepicking">
                                                ...
                                                <div class="input-group mb-3 mt-2">
                                                    <input type="text" name="search_date" value="{{date('d-M-Y')}}" placeholder="dd-mm-yyyy"
                                                           ...
                                                           autocomplete="off">
                                                    <span class="input-group-text btn bg-transparent border"
                                                          id="basic-addon2"><i
                                                ...
                                                <div class="card shadowDiv border-rounded-1 border-1 pb-3">
                                                    ...
                                                    <div class="card-body pb-0">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <i class="pointer fa fa-heart @auth {{ $item2->favouriteauth ? "text-danger" : "text-grey-three" }} addfav @endauth pt-2 " id="{{$item2->id}}" businessid="package"></i>
                                                        </div>
                                                        <div class="div">
                ...
                @foreach($rests as $rest)
                    <div class="col-md-4 col-12 mt-2">
                        <div class="image_div py-3 px-3 position-relative"
                             style="background-image:url('{{ asset('upload') }}/{{$rest->logo}}');">
                            <div class="row">
                                <div class="col-12">
                        ...
                        <div class="text-center py-3">
                            <h5 class="text-blue">{{$rest->business}}</h5>
...
@section('js')
    <script
        src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key=AIzaSyBDbX4wlNnjUXFCQhPEFf7_UNsn8WIiDNU"></script>
