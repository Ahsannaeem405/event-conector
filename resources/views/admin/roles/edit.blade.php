                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" value="{{$role->name}}" placeholder="Enter Role">
                                            </div>
                                        </div>
                                                                    ...
                                                                    @foreach($values as $value)
                                                                        <td>
                                                                            <div class="custom-control custom-checkbox">
                                                                                <input  {{ in_array($value->id, $rolePermissions) ? 'checked' : false }} type="checkbox" name="permission[]" value="{{$value->id}}" id="{{'check'.$value->id}}" class="custom-control-input">
